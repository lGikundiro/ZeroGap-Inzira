...
<body>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>INZIRA</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               INZIRA
               Email:zerogap.i.rw@gmail.com <br>
               Tel: +250783553581 <br>
               Kigali 1207,Dhanmondi:#4 <br>
    ...
    <table width="100%" style=" padding:0 10px 0 10px;">
        <tr>
            <td align="right">
                <h2><span style="color: green;">Subtotal:</span>RWF {{ $payment->total_amount }}</h2>
                <h2><span style="color: green;">Total:</span>RWF {{ $payment->total_amount }}</h2>
